    ...
    for (String mission : missions) {
      ...
      switch (mission) {
        ...
        case Define.strPTOFarmEnk: // ■ファーム
          ...
          break;
        case Define.strPTOFarmEnkNoCap: // ■ファーム
          MisIns = new PTOFarmEnkNoCap(loggg, cProps);
          break;
        ...
        case Define.strPTONaruhodo: // ■なるほど検定
          ...
          break;
        case Define.strPTOCMPochi: // ■ぽち
          MisIns = new PTOCMPochi(loggg, cProps);
          break;
        case Define.strPTOGameRarry: // ■ぽち
      ...
      if (Arrays.asList(new String[] { Define.strPTOClickCorner,
          ...
          Define.strPTONaruhodo,Define.strPTOCMPochi,Define.strPTOGameRarry
      }).contains(mission)) {
