package pointGet.mission.pto.old;
...
public class PTOAnkPark extends PTOBase {
  final String url = "https://www.pointtown.com/ptu/mypage/top";
   ...
   * @param logg
   */
  public PTOAnkPark(Logger logg, Map<String, String> cProps) {
    super(logg, cProps, "PTOアンケートパーク");
  ...
  public void privateMission(WebDriver driverAtom) {
    ...
    String enkLinkSele = "a[onclick*='アンケートパーク']", //
    a = "";
    ...
    if (isExistEle(driver, enkLinkSele)) {
      ...
      Utille.sleep(6000);
      selector = "div.enquete-list tr>td.status>a[href*='http']";
