...
public class PILAnkPark extends PILBase {
  final String url = "https://www.point-island.com/wes_enqpark.asp";
   ...
   * @param logg
   */
  public PILAnkPark(Logger logg, Map<String, String> cProps) {
    super(logg, cProps, "PILアンケートパーク");
