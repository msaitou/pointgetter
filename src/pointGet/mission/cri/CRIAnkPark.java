...
public class CRIAnkPark extends CRIBase {
   ...
   * @param logg
   */
  public CRIAnkPark(Logger logg, Map<String, String> cProps) {
    super(logg, cProps, "CRIアンケートパーク");
  ...
  public void privateMission(WebDriver driverAtom) {
    ...
    String enkLinkSele = "img[alt*='アンケートウォール']";
