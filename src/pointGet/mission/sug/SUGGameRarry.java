 ...
 * @author saitou
 */
public class SUGGameRarry extends SUGBase {
   ...
   * @param logg
   */
  public SUGGameRarry(Logger logg, Map<String, String> cProps) {
  ...
  public void privateMission(WebDriver driver) {
    ...
    // ゲームイメージ
    selector = "dt>a>img[src='//static.sugutama.jp/ssp_site/dad989fcf629d27daac07389d8d7112e.png']";
    ...
    String[] gameList = {
        "a[href*='jewel']>div>p", // jewel
        "a[href*='otenba']>div>p", // otenba
        "a[href*='bears']>div>p", // bears
        "a[href*='fish']>div>p", // fish
        "a[href*='quiz']>div>p", // quiz
        "a[href*='dinosaur']>div>p", // dinosaur
        "a[href*='race']>div>p",// race
    };
