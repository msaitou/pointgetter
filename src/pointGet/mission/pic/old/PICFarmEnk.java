package pointGet.mission.pic.old;
...
public class PICFarmEnk extends PICBase {
  ...
  public void privateMission(WebDriver driverAtom) {
    ...
    if (isExistEle(driver, enkLinkSele)) {
      ...
      Utille.url(driver, "http://p-income.agri-hatake.fun/square/surveys", logg);
      for (int k = 0; k < 4; k++) {
        if (k == 1) {
          Utille.url(driver, "http://p-income.agri-hatake.fun/square/diagnoses", logg);
        }
        else if (k == 2) {
          Utille.url(driver, "http://p-income.agri-hatake.fun/square/votes", logg);
        }
        else if (k == 3) {
          Utille.url(driver, "http://p-income.agri-hatake.fun/square/pittango", logg);
        }
