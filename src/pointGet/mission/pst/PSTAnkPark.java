...
public class PSTAnkPark extends PSTBase {
  final String url = "https://www.point-stadium.com/wes_enqpark.asp";
   ...
   * @param logg
   */
  public PSTAnkPark(Logger logg, Map<String, String> cProps) {
    super(logg, cProps, "PSTアンケートパーク");
  ...
  public void privateMission(WebDriver driverAtom) {
    ...
    Utille.sleep(3000);
    String enkLinkSele = "input[value='アンケートパークに参加']", //
    a = "";

    if (isExistEle(driver, enkLinkSele)) {
      clickSleepSelector(driver, enkLinkSele, 4000); // 遷移
      Utille.checkAndAcceptAlertUtille(driver, logg);
