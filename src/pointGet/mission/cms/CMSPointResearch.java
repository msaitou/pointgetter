...
public class CMSPointResearch extends CMSBase {
   ...
   * @param logg
   */
  public CMSPointResearch(Logger logg, Map<String, String> cProps) {
  ...
  public void privateMission(WebDriver driverAtom) {
    ...
    targetTab = "", sele1 = "form>input[type='image']", // 回答する 漫画用
    a = "";
    ...
    for (int i = 0; i < 2; i++) {
      if (i == 0) {
        ...
        targetTab = "li.tab_03>a";
      }
      else {
        selector = "div.research_box_04.research_box td>p.btn_answer>a";
        targetTab = "li.tab_04>a";
      }
      while (true) {
        if (isExistEle(driver, targetTab)) {
          clickSleepSelector(driver, targetTab, 5000); // アンケートスタートページ
        }
