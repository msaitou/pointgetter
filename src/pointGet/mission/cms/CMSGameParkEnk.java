...
public class CMSGameParkEnk extends CMSBase {
  final String url = "http://www.cmsite.co.jp/top/game/";
   ...
   * @param logg
   */
  public CMSGameParkEnk(Logger logg, Map<String, String> cProps) {
...
//        int skip = 0, beforeSize = 0;
        if (beforeSize == size) {skip++;}
          if (size > targetIndex && isExistEle(eleList, targetIndex)) {
            ...
            if (cUrl.indexOf("cmsite.qpark.jp/enquete") >= 0) {
              Utille.sleep(4000);
