 ...
 *
 */
public class GPOWhichCollectCar extends GPOBase {
   ...
   * @param logg
   */
  public GPOWhichCollectCar(Logger logg, Map<String, String> cProps) {
    super(logg, cProps, "どっちが正解？車");
