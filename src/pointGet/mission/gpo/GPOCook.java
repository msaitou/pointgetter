 ...
 *
 */
public class GPOCook extends GPOBase {
   ...
   * @param logg
   */
  public GPOCook(Logger logg, Map<String, String> cProps) {
    super(logg, cProps, "料理アンケート");
  ...
  public void privateMission(WebDriver driver) {
    ...
    String sele1 = "a[href='https://kotaete.gpoint.co.jp/']>span.navi-icon", selector2 = "a[onclick*='ryori']";
