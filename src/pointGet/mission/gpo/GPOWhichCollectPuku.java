 ...
 *
 */
public class GPOWhichCollectPuku extends GPOBase {
   ...
   * @param logg
   */
  public GPOWhichCollectPuku(Logger logg, Map<String, String> cProps) {
    super(logg, cProps, "ぷくまろうチャレンジ");
  ...
  public void privateMission(WebDriver driver) {
    ...
    String sele1 = "img[alt*='プクマロのチャレンジクイズ']";
