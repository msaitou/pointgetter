...
public class GPOGameParkEnk extends GPOBase {
   ...
   * @param logg
   */
  public GPOGameParkEnk(Logger logg, Map<String, String> cProps) {
      ...
      if (isExistEle(driver, enkLinkSele)) {
        ...
        while (true) {
          ...
          if (size > targetIndex && isExistEle(eleList, targetIndex)) {
            ...
            logg.info("url[" + cUrl + "]");
            if (cUrl.indexOf("gpoint.qpark.jp/enquete/") >= 0) {
              Utille.sleep(4000);
