 ...
 *
 */
public class CITCook extends GMYBase {
   ...
   * @param logg
   */
  public CITCook(Logger logg, Map<String, String> cProps) {
    super(logg, cProps, "料理とアンケート");
  ...
  public void privateMission(WebDriver driver) {
    ...
    Utille.sleep(3000);
    String sele1 = "img[alt='料理とアンケート']", selector2 = "li.menu03>a";
        ...
        if (isExistEle(driver, selector)) {
          ...
          if (size2 > targetIndex && isExistEle(eleList, targetIndex)) { // 古い順にやる
            ...
            if (isExistEle(driver, seleNextb2)) {
              Cooking.answer(driver, seleNextb2, wid);
